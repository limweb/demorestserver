        ...
        ?>
            <div class="card ">
                <div class="card-header d-flex align-items-start justify-content-between" style="background-color:#c3c3c3">
                    ...
                    <div class="pl-2 text-nowrap"><a href="#codegen"><input @click="genlogin" type="button" class="btn btn-sm btn-primary" value="GEN login SYSTEM" /></a></div>
                </div>
            </div>
                ...
                <div class="card-header d-flex align-items-start justify-content-between">
                    <div>
                        <div class="flex-row d-flex">
                            ...
                            <div class="pl-2 text-nowrap"><input type="checkbox" v-model="table.isModelclass" />
                                <input placeholder="Model Class" v-model="table.modelclass" />
                            </div>
                            <div class="pl-2 text-nowrap"><input type="checkbox" v-model="table.isServiceclass" />
                                <input placeholder="Service Class" v-model="table.serviceclass" />
                            </div>
                            <div class="flex-row pl-2 text-nowrap d-flex">
                                <div class="d-flex">
                            ...
                            <div class="pl-2 text-nowrap"><input type="checkbox" v-model="table.isVue2Typem" />* Vue2 TM</div>
                            <div class="pl-2 text-nowrap"><input type="checkbox" v-model="table.isVueui" />* Vue2 UI</div>
                            <div class="pl-2 text-nowrap"><input type="checkbox" v-model="table.isVue3" />* Vue3 UI</div>
                            <div class="pl-2 text-nowrap"><input type="checkbox" v-model="table.isSvelte" />* SVELTE UI</div>
                        </div>
                        <div class="flex-row d-flex ">
                    ...
                    <div class="pl-2 text-nowrap"><input type="checkbox" v-model="table.isSoftdelete" />* Soft Delete <br />
                        <div>
                    ...
                    <div class="pl-2 text-nowrap"><input type="checkbox" v-model="table.isTimestamps" />* Timestamps
                        <div>
                    ...
                    <div class="pl-2 text-nowrap"><a href="#codegen"><input @click="genbytable(table)" type="button" class="btn btn-sm btn-primary" value="GEN by Table ZIP" /></a></div>
                 </div>
