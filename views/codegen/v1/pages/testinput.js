import Avata from "../components/avata/Avata.js";
export default { 
    template: `
    ...
    data() { 
      return { 
          ...
          comps:[
            ...
            // { "is": "input_file",    "value": "", "class": "", "style": "", "id": "input_upload1", "name": "input_upload1",   "label": "input_upload", "placeholder": "input_upload" },
            // { "is": "input_upload",  "value": "", "class": "", "style": "", "id": "input_uploads1", "name": "input_uploads1", "label": "input_uploads", "placeholder": "input_uploads" },
            // { "is": "input_files",   "value": "", "class": "", "style": "", "id": "input_upload2", "name": "input_upload2",   "label": "input_upload", "placeholder": "input_upload" },
            // { "is": "input_uploads", "value": "", "class": "", "style": "", "id": "input_uploads2", "name": "input_uploads2", "label": "input_uploads", "placeholder": "input_uploads" },
            ...
            // { "is":"dropf", "value": "", "class": "", "style": "", "id": "v2yearpicke", "name": "v2yearpicke", "label": "v2yearpicke", "placeholder": "v2yearpicke",options: { url: "http://127.0.0.1", maxFilesize: 2, maxFiles: 4, chunking: true, chunkSize: 500, thumbnailWidth: 150, thumbnailHeight: 150, dictDefaultMessage: "<i class='fas fa-upload fa-3x'></i>&nbsp;&nbsp;UPLOAD ME", addRemoveLinks: true } },
            // { "is":"dropf", "value": "", "class": "", "style": "", "id": "v2yearpickex", "name": "v2yearpicke", "label": "v2yearpicke", "placeholder": "v2yearpicke",options:{ url: "http://127.0.0.1", maxFilesize: 2, maxFiles: 4, chunking: true, chunkSize: 500, thumbnailWidth: 150, thumbnailHeight: 150, dictDefaultMessage: "<i class='fas fa-upload fa-3x'></i>&nbsp;&nbsp;UPLOAD ME", addRemoveLinks: true, acceptedFiles: ".pdf,.docs,.xls,.slxs" } },
            // { "is":"totop", "id": "totop", "name": "totop", "label": "totop" },
            // { "is":"avatar", "id": "avatar", "name": "avatar", "label": "avatar" },
             { "is":"avatarx", "id": "avatarx", "name": "avatarx", "label": "avatarx" },
            // { "is":"tagsedit", "value":["Aaa",'Bbb','Ccc','Dccc','Eeee'], "id": "tagsedit", "name": "tagsedit", "label": "tagsedit" },
            // { "is":"tagsview", "value":["Aaa",'Bbb','Ccc','Dccc','Eeee'], "id": "tagsview", "name": "tagsview", "label": "tagsview" },
            // { "is":"xmodal", "value":'', show: true, "id": "tagsview", "name": "tagsview", "label": "tagsview" },
          ],
          datas:[]
      }; 
    }, 
