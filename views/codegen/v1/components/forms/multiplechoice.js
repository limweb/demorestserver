export default { 
    ...
    <div class="w-full flex flex-col">
          ...
          <div class="w-full h-12 flex items-center" v-for="(choice,idx) in value.choices" :key="idx" >
              <label<input type="radio" class='w-12' disabled><input type="text" class="p-2 w-full" v-model="choice.choice" placeholder="type your choice" ></label><span @click="rmchoice(choice)"> &nbsp;&nbsp;X&nbsp;&nbsp; </span>
          </div>
