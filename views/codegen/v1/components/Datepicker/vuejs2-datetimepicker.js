...
var utils = {
  ...
  */
  ...
  formatDate: function formatDate(date, format, translation) {
    ...
    var hour = this.getHours(date);
    var minutes = this.getMinutes(date);
    var str = format.replace(/dd/, ('0' + day).slice(-2)).replace(/d/, day).replace(/yyyy/, year).replace(/yy/, String(year).slice(2)).replace(/MMMM/, this.getMonthName(this.getMonth(date), translation.months)).replace(/MMM/, this.getMonthNameAbbr(this.getMonth(date), translation.monthsAbbr)).replace(/MM/, ('0' + month).slice(-2)).replace(/M(?!a|ä|e)/, month).replace(/su/, this.getNthSuffix(this.getDate(date))).replace(/D(?!e|é|i)/, this.getDayNameAbbr(date, translation.days)).replace(/HH/, ('0' + hour).slice(-2)).replace(/mm/, ('0' + minutes).slice(-2));
  ...
  return _c(
    ...
    [
      ...
      _c("span", { staticClass: "cell time" }, [
        _vm._v(_vm._s(("0" + _vm.utils.getHours(_vm.selectedDate)).slice(-2)))
      ]),
      _c("span", { staticClass: "cell" }, [_vm._v(":")]),
      _c("span", { staticClass: "cell time" }, [
        _vm._v(_vm._s(("0" + _vm.utils.getMinutes(_vm.selectedDate)).slice(-2)))
      ]),
      _vm._v(" "),
      _c(
        "span",
...
var script$2 = {
  ...
  computed: {
    hours: function hours() {
      ...
      return "".concat(('0' + this.utils.getHours(this.selectedDate)).slice(-2), ":").concat(('0' + this.utils.getMinutes(this.selectedDate)).slice(-2));
    },
...
var script$5 = {
  ...
  methods: {
    ...
    setDate: function setDate(timestamp) {
      ...
      let str = this.formatDate(date,this.format,this.translation);
